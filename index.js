...
function showFinalTable(input, output, outputDiv) {
    ...
    // let avgturn = document.createElement("p");
    // avgturn.innerHTML = 
...
function showAvgtat( output, outputDiv) {
    let avgtat = document.createElement("div");
    let span1 = document.createElement("span");
    span1.innerHTML = "Average Turnaround Time: ";
    avgtat.appendChild(span1);
    let span2 = document.createElement("span");
    span2.innerHTML =  output.averageTimes[1];
    avgtat.appendChild(span2);
    outputDiv.appendChild(avgtat);
}
function showAvgwt( output, outputDiv) {
    let avgtat = document.createElement("div");
    let span1 = document.createElement("span");
    span1.innerHTML = "Average Waiting Time: ";
    avgtat.appendChild(span1);
    let span2 = document.createElement("span");
    span2.innerHTML = output.averageTimes[2];
    avgtat.appendChild(span2);
    outputDiv.appendChild(avgtat);
}
function showAvgrt( output, outputDiv) {
    let avgtat = document.createElement("div");
    let span1 = document.createElement("span");
    span1.innerHTML = "Average Response Time: ";
    avgtat.appendChild(span1);
    let span2 = document.createElement("span");
    span2.innerHTML = output.averageTimes[3];
    avgtat.appendChild(span2);
    outputDiv.appendChild(avgtat);
}
function showOutput(input, output, outputDiv) {
    ...
    outputDiv.insertAdjacentHTML("beforeend", "<hr>");
    showAvgtat(output, outputDiv);
    showAvgwt(output, outputDiv);
    showAvgrt(output, outputDiv);
